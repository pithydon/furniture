...
function furniture.register_wooden(name, def)
	...
	minetest.register_abm({
		nodenames = {"furniture:chair_"..subname, "furniture:stool_"..subname, "furniture:bench_"..subname,
				"furniture:bench_middle_"..subname, "furniture:bench_right_"..subname, "furniture:bench_left_"..subname},
		interval = 1,
		chance = 1,
		action = function(pos, node)
			sit(pos, node)
